...
export const tourCategories: TourCategory[] = [
    ...
    // ─────────────────────────────────────────────
    {
        ...
        tours: [
            ...
            },
            {
                ...
                tourType: "ORGANIZED TOUR",
                itinerary: "Myrtos • Assos • Agia Efimia • Melissani • Drogarati • Winery",
                operatingDays: "Every: Saturday",
                from_price: 37.50,
                badges: { isSpecialOffer: true, isDiscount: true, discountLabel: '20% OFF!' },
                card_subtitle: "Villages, caves & local wine tasting in one full day",
                short_description: "Villages, caves & local wine tasting in one full day",
                duration: "8 Hours",
                bokunProductId: "1125442",
                baseViews: 1558,
                isBookableOnBokun: true,
                isPrivateAvailable: true,
                private_description: "Enjoy the Kefalonian Adventure exclusively with your group — no crowds, your own pace. From the jaw-dropping cliff road down to Myrtos, through the medieval lanes of Assos to Agia Efimia, with Melissani Lake, Drogarati Cave & local wine tasting included. We'll tailor the stops and timing entirely around you.",
                slides: [
    ...
    {
        id: "in-your-language",
        title: "Deutschsprachige Touren",
        subtitle: "Erleben Sie Kefalonia mit einem deutschsprachigen Reiseleiter",
        tours: [
            {
                tourTitle: "Kefalonia Entdecken",
                tourType: "EXKLUSIVE DEUTSCHE TOUR",
                itinerary: "Myrtos • Fiscardo • Assos • Melissani • Drogarati",
                operatingDays: "Jeden: Montag",
                from_price: 57.50,
                ...
                labels: {
                    ...
                    privateOption: "Privat-Option",
                    privateMobile: "Privat",
